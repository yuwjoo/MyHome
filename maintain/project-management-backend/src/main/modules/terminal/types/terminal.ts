/**
 * @file 终端类型
 * @description 定义终端模块的日志、结束信息与配置结构
 */

/**
 * 终端日志来源类型
 */
export type TTerminalLogType = 'stdout' | 'stderr' | 'command' | 'system'
 ...
 * 终端日志监听函数
 */
export type TTerminalLogListener = (log: ITerminalLog) => void

/**
 * 终端运行结束监听函数
 */
export type TTerminalExitListener = (exit: ITerminalExit) => void
