...
| 分类     | 说明                                                                                                                                                                              |
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 模块目录 | 存放一堆同类型/功能的代码文件（目录名多为结尾带s，但不是强制），可以有任意个功能文件/目录（外部只能访问功能文件的所有代码和功能目录入口文件的所有代码），和一个common目录（可选） |
| 功能目录 | 存放一种功能/特性的代码文件，必然有一个`index`入口文件（外部访问的唯一入口，其他文件禁止访问），和任意个其他文件/目录                                                             |
| 公共目录 | 存放公共代码文件，目录名为common，可以有任意个文件/目录（外部可以随意访问）                                                                                                       |
| 类型目录 | 存放ts类型代码文件，目录名为types，可以有任意个文件/目录（外部可以随意访问）                                                                                                      |
