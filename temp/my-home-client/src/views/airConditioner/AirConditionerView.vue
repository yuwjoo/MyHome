<!-- 
  * @FileName: AirConditionerView.vue
 * @FilePath: \my-home-client\src\views\airConditioner\AirConditionerView.vue
  * @Author: YH
  * @Date: 2025-11-30 22:43:54
 * @LastEditors: YH
 * @LastEditTime: 2026-03-23 20:43:46
  * @Description: 空调遥控器页面组件
 -->
<template>
...
// import ControlRing from "./components/ControlRing.vue";
